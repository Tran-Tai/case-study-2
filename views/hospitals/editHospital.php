    ...
    <div>
        <form  class="mx-auto needs-validation" method="POST">
            <fieldset>
                ...
                <input type="text" name="name" value="<?php echo $hospital->name ?>" required></br>
                <label for="address">Địa chỉ</label></br>
                <input type="text" name="address" value="<?php echo $hospital->address ?>" required></br>
                <label for="capacity">Số giường:</label></br>
                <input type="number" name="capacity" value="<?php echo $hospital->capacity ?>" required></br>
                <label for="phone_number">Số điện thoại:</label></br>
                <input type="number" name="phone_number" value="<?php echo $hospital->phone_number ?>" required></br>
