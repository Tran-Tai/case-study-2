    ...
    ";
        ...
        <form class="needs-validation" method="POST">
            <fieldset>
                ...
                <input type="number" name="identity_number" required></br>
               ...
               '<label for="contact_day">Thời điểm tiếp xúc: (từ '. $contactPerson->contact_day .' đến '. $contactPerson->quarantined_day .')</label></br>
                ...
                if ($group > 2) {
                    echo
               '<label for="contact_day">Thời điểm tiếp xúc: (đến '. $contactPerson->monitor_day .')</label></br>
                <input type="date" name="contact_day" max="'. $contactPerson->monitor_day .'"></br>
                <label for="contact_place">Địa điểm tiếp xúc:</label></br>
                <input type="text" name="contact_place"></br>';
                }
                if ($group == 0) {
