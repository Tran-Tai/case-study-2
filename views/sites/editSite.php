    ...
    <div>
        <form class="mx-auto" method="POST">
            <fieldset>
                ...
                <input type="text" name="address" value="<?php echo $site->address ?>"></br>
                <label for="capacity">Số giường:</label></br>
                <input type="number" name="capacity" value="<?php echo $site->capacity ?>"></br>
                <label for="phone_number">Số điện thoại:</label></br>
                <input type="number" name="phone_number" value="<?php echo $site->phone_number ?>"></br>
